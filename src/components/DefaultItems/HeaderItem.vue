...
export default {
  setup() {
    ...
    const darkLogoImg = require("@/assets/logo-dark.png");
...
<template>
  <div class="header-content">
    <div class="left"></div>
    <div class="logo">
      <img alt="logo" :src="isHomePage ? darkLogoImg : logoImg" />
    </div>
    <div class="right">
      <div class="menu-icon">
        <input
        ...
        <nav class="nav">
          <ul class="pt-5">
            <li>
              ...
              <router-link to="/" @click="setMenu()">首　　頁</router-link>
            </li>
            <li>
              <router-link to="/journallist" @click="setMenu()"
                >文化勤報</router-link
              >
            </li>
            <li>
              <router-link to="/" @click="setMenu()">聯絡我們</router-link>
            </li>
            <li>
              <a href="https://cci.ncut.edu.tw/index.php" @click="setMenu()"
                >勤益文創<span class="material-icons">open_in_new</span></a
              >
            </li>
          </ul>
        </nav>
